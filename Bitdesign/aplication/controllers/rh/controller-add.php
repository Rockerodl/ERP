                        ...
                        <div class="field-body">
                          <div class="field">
                            ...
                            <p class="control is-expanded">
                              <input type="text" class="input" placeholder="Nombre/s" name="nombres" id="nombres">
                            </p>
                          </div>
                          <div class="field">
                            <label class="label">Apellido paterno</label>
                            <p class="control is-expanded">
                              <input type="text" class="input" placeholder="Apellido paterno" name="apellido-p" id="apellido-p">
                            </p>
                          </div>
                          <div class="field">
                            <label class="label">Apellido materno</label>
                            <p class="control is-expanded">
                              <input type="text" class="input" placeholder="Apellido materno" name="apellido-m" id="apellido-m">
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="field is-horizontal">
                        <div class="field-body">
                          <div class="field">
                            ...
                            <p class="control is-expanded">
                              <input type="tel" class="input" placeholder="Telefono" name="telefono" id="telefono">
                            </p>
                          </div>
                          <div class="field">
                            <label class="label">Correo</label>
                            <p class="control is-expanded">
                              <input type="email" class="input" placeholder="Correo electronico" name="correo" id="correo">
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="field is-horizontal">
                        <div class="field-body">
                              ...
                              <div class="field">
                                ...
                                <p class="control is-expanded">
                                  <input type="text" class="input" placeholder="Nacionalidad" name="nacionalidad" id="nacionalidad">
                                </p>
                              </div>
